...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "connect-src 'self' https://api.stripe.com https://api.razorpay.com https://*.instagram.com https://graph.facebook.com https://*.tiktok.com https://*.googleapis.com https://*.sentry.io",
