    ...
    return {
      beforeFiles: [
        ...
        { source: "/placeholder.svg", destination: "/site/placeholder.svg" },
          {
            source:
              "/:path((?!api|_next|site|legal(?:/|$)|auth/callback(?:/|$)|verify-email(?:/|$)|r(?:/|$)|o(?:/|$)|sitemap\\.xml$|brand/auth(?:/|$)|brand/login(?:/|$)|brand/signup(?:/|$)|brand/dashboard(?:/|$)|brand/campaigns(?:/|$)|brand/pipeline(?:/|$)|brand/analytics(?:/|$)|influencer/auth(?:/|$)|influencer/login(?:/|$)|influencer/signup(?:/|$)|onboarding(?:/|$)|.*\\.txt$).*)",
