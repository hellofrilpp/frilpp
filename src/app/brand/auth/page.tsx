          ...
          <CardContent>
            ...
            <div className="mb-6">
              <a
                ...
                className="flex w-full items-center justify-center gap-3 border-2 border-border bg-background px-4 py-3 font-mono text-sm hover:border-neon-green hover:bg-neon-green/10 transition-colors"
              >
